...
enum PassaquiButtonStyle { primary, secondary, defaultLight, defaultDark, invertedPrimary }
    ...
    switch (style) {
      ...
      case PassaquiButtonStyle.invertedPrimary:
        return ButtonStyle(
          ...
          foregroundColor: MaterialStateProperty.all<Color>(const Color.fromRGBO(18, 96, 73, 1)),
          minimumSize: MaterialStateProperty.all<Size>(minimumSize ?? const Size(0, 0)),
          shape: MaterialStateProperty.all<RoundedRectangleBorder>(
            RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(borderRadius),
    ...
    switch (style) {
      ...
      case PassaquiButtonStyle.invertedPrimary:
        return TextStyle(
          ...
          fontWeight: fontWeight, // Use the parameter
          fontSize: fontSize, // Use the parameter
          color: const Color.fromRGBO(18, 96, 73, 1), // Fixed green color for inverted primary
        );
      case PassaquiButtonStyle.secondary:
        return TextStyle(
          fontFamily: 'Inter',
  ...
  Icon _getIconStyle() {
    switch (style) {
      ...
      case PassaquiButtonStyle.invertedPrimary:
        return Icon(
          Icons.arrow_forward,
          color: iconColor ?? const Color.fromRGBO(18, 96, 73, 1), // Use iconColor if provided, else default to green
          size: arrowSize ?? 24, // Use arrowSize if provided, else default to 24
        );
      case PassaquiButtonStyle.secondary:
        return Icon(
